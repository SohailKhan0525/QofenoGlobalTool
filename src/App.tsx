...
// Delta X offsets to collapse each letter left towards the Q mark
const DELTA_COLLAPSED = [-141, -284, -389, -494, -613] as const;
...
function QofenoLogo({
  ...
  useEffect(() => {
    ...
    // Staggered entrance animation: slide right from x: -60 to x: 0
  ...
  return (
    ...
    >
      <svg viewBox="0 0 784 132" className="block w-full h-full" fill="currentColor">
        <g fill="currentColor">
          {/* Q Ring */}
          <path d="M 84.00 129.00 A 65.9 65.9 0 1 1 120.00 100.50 L 108.00 90.00 A 49.2 49.2 0 1 0 73.00 115.00 Z" />
          {/* Q Tail */}
