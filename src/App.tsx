  ...
  return (
    <TooltipProvider>
      ...
      <motion.header
        ...
        className={cn(
          'fixed top-0 left-0 right-0 z-50 flex items-center px-4 md:px-8 transition-all duration-300 select-none h-[76px]',
          navbarScrolled
            ? 'bg-white/85 backdrop-blur-[20px] backdrop-saturate-[160%] border-b border-purple-100/60 shadow-md shadow-purple-500/5'
            : 'bg-transparent'
        )}
      >
