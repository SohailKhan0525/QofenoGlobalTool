...
// using pure CSS transitions on inline SVG groups from your canonical qofeno_full.svg.
function QofenoLogo({
  size = 36,
  showText = true,
  invert = false,
  ...
  // Bounding box of qofeno_full.svg is 0 0 784 132 (ratio: 5.939)
  // If text is hidden (like in tiny containers), we only show the Q mark (from x = 0 to 150)
  ...
  return (
    ...
    >
      ...
      >
        <g fill="currentColor">
          {/* Q Logo (always visible, fixed position) */}
          ...
          {/* Wordmark letters: staggered translate-right and fade out */}
          {showText && (
            <g>
              {/* O (translated 150.00,0) */}
              <g
                style={{
                  transform: collapsed ? 'translate(180px, 0px)' : 'translate(150px, 0px)',
                  opacity: collapsed ? 0 : 1,
                  transition: 'transform 480ms cubic-bezier(.77,0,.175,1), opacity 300ms ease',
                  transitionDelay: collapsed ? '160ms' : '0ms'
                }}
              >
                <path d="M 131.98 64.38 L 131.92 62.76 L 131.82 61.14 L 131.68 59.53 L 131.50 57.92 L 131.29 56.32 L 131.03 54.72 L 130.73 53.12 L 130.40 51.54 L 130.02 49.96 L 129.61 48.40 L 129.16 46.84 L 128.67 45.30 L 128.14 43.77 L 127.58 42.25 L 126.98 40.74 L 126.34 39.25 L 125.66 37.78 L 124.95 36.33 L 124.21 34.89 L 123.43 33.47 L 122.61 32.07 L 121.76 30.69 L 120.88 29.33 L 119.96 28.00 L 119.01 26.68 L 118.03 25.39 L 117.02 24.13 L 115.98 22.89 L 114.90 21.68 L 113.80 20.49 L 112.67 19.33 L 111.51 18.20 L 110.32 17.10 L 109.11 16.02 L 107.87 14.98 L 106.61 13.97 L 105.32 12.99 L 104.00 12.04 L 102.67 11.12 L 101.31 10.24 L 99.93 9.39 L 98.53 8.57 L 97.11 7.79 L 95.67 7.05 L 94.22 6.34 L 92.75 5.66 L 91.26 5.02 L 89.75 4.42 L 88.23 3.86 L 86.70 3.33 L 85.16 2.84 L 83.60 2.39 L 82.04 1.98 L 80.46 1.60 L 78.88 1.27 L 77.28 0.97 L 75.68 0.71 L 74.08 0.50 L 72.47 0.32 L 70.86 0.18 L 69.24 0.08 L 67.62 0.02 L 66.00 0.00 L 64.38 0.02 L 62.76 0.08 L 61.14 0.18 L 59.53 0.32 L 57.92 0.50 L 56.32 0.71 L 54.72 0.97 L 53.12 1.27 L 51.54 1.60 L 49.96 1.98 L 48.40 2.39 L 46.84 2.84 L 45.30 3.33 L 43.77 3.86 L 42.25 4.42 L 40.74 5.02 L 39.25 5.66 L 37.78 6.34 L 36.33 7.05 L 34.89 7.79 L 33.47 8.57 L 32.07 9.39 L 30.69 10.24 L 29.33 11.12 L 28.00 12.04 L 26.68 12.99 L 25.39 13.97 L 24.13 14.98 L 22.89 16.02 L 21.68 17.10 L 20.49 18.20 L 19.33 19.33 L 18.20 20.49 L 17.10 21.68 L 16.02 22.89 L 14.98 24.13 
64.79 16.71 L 66.00 16.70 L 67.21 16.71 L 68.42 16.76 L 69.63 16.83 L 70.83 16.94 L 72.03 17.07 L 73.23 17.23 L 74.43 17.43 L 75.62 17.65 L 76.80 17.90 L 77.98 18.18 L 79.15 18.49 L 80.31 18.82 L 81.46 19.19 L 82.61 19.58 L 83.74 20.00 L 84.87 20.45 L 85.98 20.93 L 87.08 21.43 L 88.17 21.96 L 89.24 22.52 L 90.30 23.10 L 91.35 23.71 L 92.38 24.35 L 93.39 25.01 L 94.39 25.69 L 95.37 26.40 L 96.33 27.13 L 97.28 27.89 L 98.20 28.67 L 99.11 29.47 L 99.99 30.29 L 100.86 31.14 L 101.71 32.01 L 102.53 32.89 L 103.33 33.80 L 104.11 34.72 L 104.87 35.67 L 105.60 36.63 L 106.31 37.61 L 106.99 38.61 L 107.65 39.62 L 108.29 40.65 L 108.90 41.70 L 109.48 42.76 L 110.04 43.83 L 110.57 44.92 L 111.07 46.02 L 111.55 47.13 L 112.00 48.26 L 112.42 49.39 L 112.81 50.54 L 113.18 51.69 L 113.51 52.85 L 113.82 54.02 L 114.10 55.20 L 114.35 56.38 L 114.57 57.57 L 114.77 58.77 L 114.93 59.97 L 115.06 61.17 L 115.17 62.37 L 115.24 63.58 L 115.29 64.79 L 115.30 66.00 Z" />
              </g>

              {/* F (translated 302.00,0) */}
              <g
                style={{
                  transform: collapsed ? 'translate(332px, 0px)' : 'translate(302px, 0px)',
                  opacity: collapsed ? 0 : 1,
                  transition: 'transform 480ms cubic-bezier(.77,0,.175,1), opacity 300ms ease',
                  transitionDelay: collapsed ? '120ms' : '40ms'
                }}
              >
              ...
              <g
                style={{
                  transform: collapsed ? 'translate(444px, 0px)' : 'translate(414px, 0px)',
                  opacity: collapsed ? 0 : 1,
                  transition: 'transform 480ms cubic-bezier(.77,0,.175,1), opacity 300ms ease',
                  transitionDelay: collapsed ? '80ms' : '80ms'
                }}
              >
              ...
              <g
                style={{
                  transform: collapsed ? 'translate(556px, 0px)' : 'translate(526px, 0px)',
                  opacity: collapsed ? 0 : 1,
                  transition: 'transform 480ms cubic-bezier(.77,0,.175,1), opacity 300ms ease',
                  transitionDelay: collapsed ? '40ms' : '120ms'
                }}
              >
              ...
              <g
                style={{
                  transform: collapsed ? 'translate(682px, 0px)' : 'translate(652px, 0px)',
                  opacity: collapsed ? 0 : 1,
                  transition: 'transform 480ms cubic-bezier(.77,0,.175,1), opacity 300ms ease',
  ...
  return (
    <TooltipProvider>
      ...
      <motion.header
        ...
        className={cn(
          'fixed top-0 left-0 right-0 z-50 flex items-center px-4 md:px-8 transition-all duration-300 select-none h-[76px] border-b',
          navbarScrolled
            ? 'bg-white/85 backdrop-blur-[20px] backdrop-saturate-[160%] border-purple-100/60 shadow-md shadow-purple-500/5'
