      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-neutral-500">
            {isLogin 
              ? 'Sign in to access your Pro tools and history' 
              : 'Unlock Pro tools and save your processing history'
            }
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-neutral-50 border border-neutral-200 focus:border-purple-600 focus:bg-white px-4 py-3.5 rounded-xl outline-none transition-all text-neutral-800 text-sm font-medium"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-neutral-50 border border-neutral-200 focus:border-purple-600 focus:bg-white pl-10 pr-4 py-3.5 rounded-xl outline-none transition-all text-neutral-800 text-sm font-medium"
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between ml-1">
              ...
              {isLogin && <button type="button" className="text-[11px] font-bold text-purple-600 hover:text-purple-700 cursor-pointer">Forgot?</button>}
            </div>
            <div className="relative">
              <input 
                ...
                className="w-full bg-neutral-50 border border-neutral-200 focus:border-purple-600 focus:bg-white pl-10 pr-10 py-3.5 rounded-xl outline-none transition-all text-neutral-800 text-sm font-medium"
                placeholder="••••••••"
              />
          ...
          {!isLogin && (
            <div className="pt-2 space-y-3">
              ...
              <label className="flex items-start gap-2 cursor-pointer group">
                ...
                <span className="text-[11px] font-medium text-neutral-600 leading-tight">
                  (Optional) Send me product updates, feature announcements, and Qofeno news.
                </span>
              </label>
            </div>
          )}
