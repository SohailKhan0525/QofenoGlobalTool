/**
 * Shared utilities for all PDF Appwrite functions.
 * Copy this file to any function's src/ directory that needs it.
 */
...
export function decodeFileInput(value) {
...
export async function readInputBuffer(body) {
...
export async function uploadOutput(storage, filename, buffer) {
...
export async function createExecutionRecord(db, payload) {
  try {
...
export async function processWithRetry(processFn, maxRetries = 2) {
  let lastError;
...
export function validatePdfOutput(buffer) {
